    ...
    public partial class newMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupplierBrand", x => new { x.BrandId, x.SuppliersId });
                    table.ForeignKey(
                        name: "FK_SupplierBrand_Brands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SupplierBrand_Suppliers_SuppliersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Street_Neighborhood_NeighborhoodId",
            ...
            migrationBuilder.InsertData(
                table: "Suppliers",
                columns: new[] { "Id", "AccountId", "AddressId", "Name", "Rating" },
                values: new object[,]
                {
                    { 1, null, null, "Koc Holding", 5.0999999999999996 },
                    { 2, null, null, "Sabanci Holding", 5.5 },
                    { 3, null, null, "Zorlu Holding", 5.7000000000000002 },
                    { 4, null, null, "Dogan Holding", 5.5 },
                    { 5, null, null, "Kamci Holding", 8.0999999999999996 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Street_NeighborhoodId",
                table: "Street",
                column: "NeighborhoodId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierBrand_SuppliersId",
                table: "SupplierBrand",
                column: "SuppliersId");
