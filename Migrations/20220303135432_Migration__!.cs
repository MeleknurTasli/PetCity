...
{
    public partial class Migration__ : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Regions", x => x.DistrictId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Incidences_Regions_DistrictId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Neighborhood_Regions_DistrictId",
                        column: x => x.DistrictId,
                        principalTable: "Regions",
                        principalColumn: "DistrictId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Incidences",
                columns: new[] { "Id", "Date", "Description", "DistrictId", "Image", "Name", "UserId", "Visibility" },
                values: new object[,]
                {
                    { 1, null, "kedi çok aç", null, null, "Kedi ac", 1, true },
                    { 2, null, "köpek çok aç", null, null, "Kopek ac", 2, true }
                });
