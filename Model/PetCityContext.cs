    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Country>(entity =>
       {
        ...
        modelBuilder.Entity<State>(entity =>
         {
             ...
             entity.Property(e => e.Name).IsRequired();
             entity.HasOne(e => e.Country).WithMany(c => c.state);
        ...
        modelBuilder.Entity<City>(entity =>
        {
            ...
            entity.HasOne(c => c.State).WithMany(c => c.city);
        ...
        modelBuilder.Entity<District>(entity =>
       {
           ...
           entity.Property(e => e.Name);
           entity.HasOne(c => c.City).WithMany(c => c.District);
       });
        ...
        modelBuilder.Entity<Neighborhood>(entity =>
              {
                  ...
                  entity.Property(e => e.Name);
                  entity.HasOne(e => e.District).WithMany(e => e.Neighborhood);
        ...
        modelBuilder.Entity<Street>(entity =>
               {
                   entity.HasKey(e => e.Id);
                   entity.Property(e => e.Name);
                   entity.HasOne(e => e.Neighborhood).WithMany(e => e.Street);
